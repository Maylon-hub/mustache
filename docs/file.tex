...
\texttt{mustache-core} 0.3.0rc1 e \texttt{core-sg-mustache} 0.4.5rc1 foram preparadas para o
...
TestPyPI são \texttt{mustache-core} 0.3.0rc1 e \texttt{core-sg-mustache} 0.4.5rc1. O backend
...
\begin{itemize}
  ...
  \item \textbf{Pacotes Python publicados no TestPyPI:}
        \begin{itemize}
          \item \texttt{mustache-core} (v0.3.0rc1) -- \url{https://test.pypi.org/project/mustache-core/};
          \item \texttt{core-sg-mustache} (v0.4.5rc1) -- \url{https://test.pypi.org/project/core-sg-mustache/};
        \end{itemize}
