...
script_path = Path(r"C:\Users\guest\Documents\GitHub\mustache\scripts\benchmark_coresg_vs_hdbscan_canonical.py")
script_path.write_text(script_content, encoding="utf-8")
print("Script benchmark_coresg_vs_hdbscan_canonical.py created successfully!")