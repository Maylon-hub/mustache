filePath = r"C:\Users\guest\Documents\GitHub\mustache\scripts\benchmark_coresg_vs_hdbscan.py"
...
print("Successfully updated scripts/benchmark_coresg_vs_hdbscan.py!")